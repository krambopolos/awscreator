...
def main():
    ...
    while regions_to_try:
        ...
        if available_instance_type:
            ...
            print(f"No available instance types found in {default_region}. Trying another region...")
        ...
        try:
            ...
            if "Blocked" in str(e):
                print(f"Account is blocked in region {default_region}. Trying another region...")
                if default_region in regions_to_try:
                    regions_to_try.remove(default_region)
                if not regions_to_try:
                    print("No regions left to try. Exiting.")
