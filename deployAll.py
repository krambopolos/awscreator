...
def main():
    ...
    if not region_instance_counts:
        print("No regions available or failed to fetch running instances.")
        sys.exit(1)

    default_region = max(region_instance_counts, key=region_instance_counts.get, default='us-east-1')
    print(f"The region with the most running instances is: {default_region}")
    ...
    # Exemple de VPC, Subnet, Security Group - A remplacer par vos valeurs réelles
